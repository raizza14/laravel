import { TASK_STATUS_TEXT_MAP, TASK_STATUS_CLASS_MAP, TASK_PRIORITY_TEXT_MAP, TASK_PRIORITY_CLASS_MAP } from "@/constants";
                            ...
                            <div className="grid gap-4 grid-cols-2 mt-2">
                                ...
                                <div>
                                    ...
                                    <div className="mt-4">
                                        ...
                                        <p className="mt-1">
                                            <Link href={route("project.show", task.project.id)} clasName="hover:underline">
                                                {task.project.name}
                                            </Link>
                                        </p>
                                    </div>
